...
const baseUrl = stripTrailingSlash(process.env.ADDIN_BASE_URL ?? 'https://localhost:3002');
...
<OfficeApp xmlns="http://schemas.microsoft.com/office/appforoffice/1.1"
  ...
  <Id>94195dc0-088f-4312-bb51-1eae5c960bb7</Id>
  <Version>1.0.0.0</Version>
  <ProviderName>XpertAI</ProviderName>
  <DefaultLocale>en-US</DefaultLocale>
  <DisplayName DefaultValue="XpertAI Excel Copilot"/>
  <Description DefaultValue="ChatKit-powered XpertAI Copilot for Excel."/>
...
${Array.from(appDomains)
  ...
  <VersionOverrides xmlns="http://schemas.microsoft.com/office/taskpaneappversionoverrides" xsi:type="VersionOverridesV1_0">
    ...
    <Resources>
      ...
      <bt:LongStrings>
        <bt:String id="GetStarted.Description" DefaultValue="Open the task pane to chat with XpertAI and edit the workbook."/>
        <bt:String id="TaskpaneButton.Tooltip" DefaultValue="Open XpertAI Excel Copilot."/>
      </bt:LongStrings>
    </Resources>
  </VersionOverrides>
</OfficeApp>
